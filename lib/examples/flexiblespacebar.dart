      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('The part of a Material Design AppBar that expands, collapses, and stretches.'),
            ...
            const SizedBox(height: 8),
            SelectableText('https://api.flutter.dev/material/FlexibleSpaceBar-class.html'),
