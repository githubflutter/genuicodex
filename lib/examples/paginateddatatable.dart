      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('A table that follows the Material 2 design specification, using multiple pages to display data.'),
            ...
            const SizedBox(height: 8),
            SelectableText('https://api.flutter.dev/material/PaginatedDataTable-class.html'),
