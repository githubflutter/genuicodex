      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('A Material button that allows the user to select from limited set of options.'),
            ...
            const SizedBox(height: 8),
            SelectableText('https://api.flutter.dev/material/SegmentedButton-class.html'),
