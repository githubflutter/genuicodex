      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('A page view that displays the widget which corresponds to the currently selected tab.'),
            ...
            const SizedBox(height: 8),
            SelectableText('https://api.flutter.dev/material/TabBarView-class.html'),
